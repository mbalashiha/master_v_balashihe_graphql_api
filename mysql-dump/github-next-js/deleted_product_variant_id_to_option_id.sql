...
-- Дамп структуры для таблица github-next-js.deleted_product_variant_id_to_option_id
...
-- Дамп данных таблицы github-next-js.deleted_product_variant_id_to_option_id: ~0 rows (приблизительно)
