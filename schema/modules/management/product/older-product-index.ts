...
export const shopProductModule = createModule({
  id: "shop-product-module",
  dirname: __dirname,
  typeDefs: [
    gql`
      type PageInfo {
  ...
  resolvers: {
    ...
    ProductConnection: {
      nodes: async (
        parent: { offset: any; limit: any },
        variables: { offset: any; limit: any },
        _ctx: any,
        info: GraphQLResolveInfo
      ) => {
    ...
    LineItemConnection: {
      nodes: async (
        ...
        variables: { offset: number; limit: number; checkoutId: any; id: any },
        _ctx: any,
        info: GraphQLResolveInfo
      ) => {
    ...
    Query: {
      ...
      checkout: async (
        _: any,
        variables: { id: any; checkoutId: any },
        _ctx: any,
        info: GraphQLResolveInfo
      ) => {
